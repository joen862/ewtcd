    ...
    <div class="container grid grid-dashboard">
        <div class="metrics-container">
            <div class="block">
                ...
                <table>
                    <tr>
                        <td>Max Supply <i class="fa fa-light fa-circle-info" title="The maximum amount of EWT that will be brought into existence. It is generated by block rewards that are added to the Validator wallets and EWF Community Fund wallet."></i></td>
                        <td>{{number_format(100000000)}}</td>
                    </tr>
                    <tr>
                        <td>Total Supply <i class="fa fa-light fa-circle-info" title="The total supply of EWT is fetched from https://explorer.energyweb.org/api?module=stats&action=coinsupply"></td>
                    ...
                    <tr>
                        <td colspan="2">Not in circulation  <i class="fa fa-light fa-circle-info" title="This is considered not in circulation. Given that supply.energyweb.org gives a circulating supply which is the same as the total minus these wallets."></td>
                    </tr>
                    <tr>
                        <td style="font-weight:normal;">Team (Endowment & Ops):</td>
                        <td>{{number_format($wallets['team']['balance'])}}</td>
                    </tr>
                    <tr>
                        <td style="font-weight:normal;">Community Fund:</td>
                        <td>{{number_format($wallets['community']['balance'])}}</td>
                    </tr>
                    <tr>
                        <td style="font-weight:normal;">Founder1:</td>
                    ...
                    <tr>
                        <td colspan="2">In Circulation  <i class="fa fa-light fa-circle-info" title="All other wallets that are considered in circulation. Lockup periods have ended, so these funds can move into general circulation at any moment."></td>
                    </tr>
                    <tr>
                        <td style="font-weight:normal;">Founder2:</td>
                        <td>{{number_format($data['founder2-total'])}}</td>
                    </tr>
                    <tr>
                        <td style="font-weight:normal;">Round A Affiliates:</td>
                        <td>{{number_format($data['rounda-total'])}}</td>
                    </tr>
                    <tr>
                        <td style="font-weight:normal;">Round B/C Affiliates:</td>
                        <td>{{number_format($data['roundbc-total'])}}</td>
                    </tr>
                    <tr>
                        <td style="font-weight:normal;">All other:</td>
                        <td>{{number_format($data['circulating-supply']-$data['founder2-total']-$data['rounda-total']-$data['roundbc-total'])}}</td>
                    </tr>
                    ...
                    <tr>
                        <td>Circulating Supply <i class="fa fa-light fa-circle-info" title="The total circulating supply of EWT is fetched from https://supply.energyweb.org and is confirmed by EW to be correct. It seems to be the tot supply minus the Team, Community Fund and Holding (unclaimed Founder 1) wallets."></td>
                        <td>{{number_format($data['circulating-supply'])}}</td>
                    </tr>
                    <tr>
                        <td colspan="2" style="font-weight:normal;">(Circulating = Total - Team - Community - Founder1)</td>
                    </tr>
            ...
            <div class="block">
                ...
                <table>
                    ...
                    <tr>
                        <td>Market Cap  <i class="fa fa-light fa-circle-info" title="This is a calculated marketcap of circulating supply times price. The marketcap given by CoinMarketCap is incorrect. "></td>
